...
class enginfo2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val cplusinform = resources.getString(R.string.enginform2)
        textView.text = cplusinform

        textView1 = findViewById(R.id.textView7)
        val cplusname = resources.getString(R.string.engname2)
        ...
        nextButtonnn.setOnClickListener {
            val intent = Intent(this@enginfo2, engtest2::class.java)
            startActivity(intent)
            finish()
        }
        val nextButton1: Button = findViewById(R.id.testlistbutton1)
        nextButton1.setOnClickListener {
            val intent = Intent(this@enginfo2, testlist2::class.java)
            startActivity(intent)
            finish()
        }
    }
