...
class sisinfo : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val kotinform = resources.getString(R.string.sisinform)
        textView.text = kotinform

        textView1 = findViewById(R.id.textView7)
        val kotname = resources.getString(R.string.sisname)
        ...
        nextButtonnn.setOnClickListener {
            val intent = Intent(this@sisinfo, sistest::class.java)
            startActivity(intent)
            finish()
        }
        val nextButton1: Button = findViewById(R.id.testlistbutton1)
        nextButton1.setOnClickListener {
            val intent = Intent(this@sisinfo, testlist3::class.java)
            startActivity(intent)
            finish()
        }
    }
