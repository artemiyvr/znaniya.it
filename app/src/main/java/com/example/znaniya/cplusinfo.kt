...
class cplusinfo : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val cplusinform = resources.getString(R.string.cplusinform)
        textView.text = cplusinform

        textView1 = findViewById(R.id.textView7)
        val cplusname = resources.getString(R.string.cplusname)
        ...
        nextButtonnn.setOnClickListener {
            val intent = Intent(this@cplusinfo, cplustest::class.java)
            startActivity(intent)
            finish()
        }
        val nextButton1: Button = findViewById(R.id.testlistbutton1)
        nextButton1.setOnClickListener {
            val intent = Intent(this@cplusinfo, testlist2::class.java)
            startActivity(intent)
            finish()
        }
    }
