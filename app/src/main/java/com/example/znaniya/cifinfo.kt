...
class cifinfo : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val cplusinform = resources.getString(R.string.cifinform)
        textView.text = cplusinform

        textView1 = findViewById(R.id.textView7)
        val cplusname = resources.getString(R.string.cifname)
        ...
        nextButtonnn.setOnClickListener {
            val intent = Intent(this@cifinfo, ciftest::class.java)
            startActivity(intent)
            finish()
        }
        val nextButton1: Button = findViewById(R.id.testlistbutton1)
        nextButton1.setOnClickListener {
            val intent = Intent(this@cifinfo, testlist4::class.java)
            startActivity(intent)
            finish()
        }
    }
