...
class enginfo3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val kotinform = resources.getString(R.string.enginform3)
        textView.text = kotinform

        textView1 = findViewById(R.id.textView7)
        val kotname = resources.getString(R.string.engname3)
        ...
        nextButtonnn.setOnClickListener {
            val intent = Intent(this@enginfo3, engtest3::class.java)
            startActivity(intent)
            finish()
        }
        val nextButton1: Button = findViewById(R.id.testlistbutton1)
        nextButton1.setOnClickListener {
            val intent = Intent(this@enginfo3, testlist3::class.java)
            startActivity(intent)
            finish()
        }
    }
