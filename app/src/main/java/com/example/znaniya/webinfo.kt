...
class webinfo : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val cplusinform = resources.getString(R.string.webinform)
        textView.text = cplusinform

        textView1 = findViewById(R.id.textView7)
        val cplusname = resources.getString(R.string.webname)
        ...
        nextButtonnn.setOnClickListener {
            val intent = Intent(this@webinfo, webtest::class.java)
            startActivity(intent)
            finish()
        }
        val nextButton1: Button = findViewById(R.id.testlistbutton1)
        nextButton1.setOnClickListener {
            val intent = Intent(this@webinfo, testlist4::class.java)
            startActivity(intent)
            finish()
        }
    }
