...
class enginfo4 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val cplusinform = resources.getString(R.string.enginform4)
        textView.text = cplusinform

        textView1 = findViewById(R.id.textView7)
        val cplusname = resources.getString(R.string.engname4)
        ...
        nextButtonnn.setOnClickListener {
            val intent = Intent(this@enginfo4, engtest4::class.java)
            startActivity(intent)
            finish()
        }
        val nextButton1: Button = findViewById(R.id.testlistbutton1)
        nextButton1.setOnClickListener {
            val intent = Intent(this@enginfo4, testlist4::class.java)
            startActivity(intent)
            finish()
        }
    }
